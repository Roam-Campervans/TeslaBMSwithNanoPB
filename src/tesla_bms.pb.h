...
#define TeslaBMS_Pack_Module_init_default        {0, 0, 0, 0, 0, {{NULL}, NULL}}
#define TeslaBMS_Pack_Cell_init_default          {0, 0, {{NULL}, NULL}}
#define TeslaBMS_Pack_init_zero                  {{{NULL}, NULL}, 0, 0, 0, {{NULL}, NULL}}
#define TeslaBMS_Pack_Module_init_zero           {0, 0, 0, 0, 0, {{NULL}, NULL}}
#define TeslaBMS_Pack_Cell_init_zero             {0, 0, {{NULL}, NULL}}
...
#define TeslaBMS_Pack_Cell_cellId_tag            1
#define TeslaBMS_Pack_Cell_cellVolt_tag          2
#define TeslaBMS_Pack_Cell_balanceState_tag      3
